  ...
  return (
    <Layout>
      <div className="max-w-3xl mx-auto">
        ...
        <p>El trastorn es pot diagnosticar durant tota la vida, particularment en els individus que presenten també discapacitat intel·lectual (APA, 2014).</p>
        <p>Els individus poden descriure el comportament com a habitual o fora del seu control (APA, 2014).</p>
        <p>Es pot produir malnutrició, en nens, adolescents i adults, a causa de la imminent la regurgitació i expulsió dels aliments després de cada ingesta (APA, 2014) i quan la regurgitació s'acompanya d'una restricció de la ingesta, degut a que intentaran evitar menjar amb altres persones pel conegut rebuig social que existeix cap a aquest comportament (APA, 2014).</p>
      </div>
    </Layout>
  );
}

export default TRRuminacioPage;