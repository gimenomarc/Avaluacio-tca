        ...
        <Layout>
            <div className="text-black">
                ...
                <div className="mt-8 grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    <Link to="/infoTCA/pica" className="border-2 border-black rounded-lg py-4 px-6 text-center h-48 hover:bg-green-500 hover:text-black transition-colors duration-200">
                        <div className="flex justify-center items-center h-full">
                            Pica
                        </div>
                    </Link>
                    <Link to="/infoTCA/trastorn-ruminacio" className="border-2 border-black rounded-lg py-4 px-6 text-center h-48 hover:bg-green-500 hover:text-black transition-colors duration-200">
                        <div className="flex justify-center items-center h-full">
                            Trastorn de Ruminació
                        </div>
                    </Link>
                    <Link to="/infoTCA/trastorn-ingesta-aliments" className="border-2 border-black rounded-lg py-4 px-6 text-center h-48 hover:bg-green-500 hover:text-black transition-colors duration-200">
                        <div className="flex justify-center items-center h-full">
                            Trastorn d'Evitació/Restricció de la Ingesta d'Aliments
                        </div>
                    </Link>
                    <Link to="/infoTCA/anorexia-nerviosa" className="border-2 border-black rounded-lg py-4 px-6 text-center h-48 hover:bg-green-500 hover:text-black transition-colors duration-200">
                        <div className="flex justify-center items-center h-full">
                            Anorèxia Nerviosa
                        </div>
                    </Link>
                    <Link to="/infoTCA/bulimia-nerviosa" className="border-2 border-black rounded-lg py-4 px-6 text-center h-48 hover:bg-green-500 hover:text-black transition-colors duration-200">
                        <div className="flex justify-center items-center h-full">
                            Bulímia Nerviosa
                        </div>
                    </Link>
                    <Link to="/infoTCA/trastorn-fartaneres" className="border-2 border-black rounded-lg py-4 px-6 text-center h-48 hover:bg-green-500 hover:text-black transition-colors duration-200">
                        <div className="flex justify-center items-center h-full">
