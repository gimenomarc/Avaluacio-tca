    ...
    <nav className="bg-gray-700 p-6">
      <ul className="flex space-x-10">
        <li className="relative group">
          ...
          <ul className="absolute left-0 mt-2 w-60 bg-gray-700 shadow-lg hidden group-hover:block">
            ...
            <li>
              <Link className="block px-4 py-2 text-white hover:bg-gray-900" to="/infoTCA/trastorn-ingesta-aliments">TRASTORN D’EVITACIÓ/RESTRICCIÓ DE LA INGESTA D’ALIMENTS</Link>
            </li>
            <li>
              <Link className="block px-4 py-2 text-white hover:bg-gray-900" to="/infoTCA/anorexia-nerviosa">ANORÈXIA NERVIOSA</Link>
            </li>
            <li>
